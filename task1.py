...
class Gardener:
    ...
    def knowledge_base():
        ...
        print("Садово́дство — отрасль растениеводства, занимающаяся возделыванием "
              "многолетних плодовых или ягодных культур для получения фруктов, " 
              "ягод и орехов (плодоводство); и выращиванием декоративных растений "
              "(декоративное садоводство). Садоводство может быть очень специализированным, "
              "с выращиванием только одного вида растений или с участием множества растений "
              "в смешанных посадках. Оно предполагает активное участие в выращивании растений "
              "и, как правило, является трудоёмким, что отличает его от сельского или лесного "
              "хозяйства.")
